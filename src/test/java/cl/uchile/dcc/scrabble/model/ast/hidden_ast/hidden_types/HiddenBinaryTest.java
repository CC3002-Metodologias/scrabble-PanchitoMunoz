...
class HiddenBinaryTest extends BaseHTypeTest {
    ...
    void testToHiddenBool() {
        assertNull(hiddenBinary1.toHiddenBool(),
    ...
    void testAdd() {
        ...
        assertNull(hiddenBinary1.add(trueHiddenBool),
            "Method add does not works with booleans." + messageSeed);
        assertNull(hiddenBinary1.add(falseHiddenBool),
            "Method add does not works with booleans." + messageSeed);

        assertNull(hiddenBinary1.add(hiddenFloat1), "Method add does not works with floats." + messageSeed);
        ...
        assertNull(hiddenBinary1.add(hiddenString1), "Method add does not works with strings." + messageSeed);
    }
    ...
    void testAnd() {
        ...
        assertNull(hiddenBinary1.and(hiddenFloat1), "Method and does not works with floats." + messageSeed);

        assertNull(hiddenBinary1.and(hiddenInt1), "Method and does not works with ints." + messageSeed);

        assertNull(hiddenBinary1.and(hiddenString1), "Method and does not works with string." + messageSeed);
    }
    ...
    void testDiv() {
        ...
        assertNull(hiddenBinary1.div(trueHiddenBool),
            "Method div does not works with booleans." + messageSeed);
        assertNull(hiddenBinary1.div(falseHiddenBool),
            "Method div does not works with booleans." + messageSeed);

        assertNull(hiddenBinary1.div(hiddenFloat1), "Method div does not works with floats." + messageSeed);
        ...
        assertNull(hiddenBinary1.div(hiddenString1), "Method div does not works with strings." + messageSeed);
    }
    ...
    void testMult() {
        ...
        assertNull(hiddenBinary1.mult(trueHiddenBool),
            "Method mult does not works with booleans." + messageSeed);
        assertNull(hiddenBinary1.mult(falseHiddenBool),
            "Method mult does not works with booleans." + messageSeed);

        assertNull(hiddenBinary1.mult(hiddenFloat1), "Method mult does not works with floats." + messageSeed);
        ...
        assertNull(hiddenBinary1.mult(hiddenString1),
    ...
    void testOr() {
        ...
        assertNull(hiddenBinary1.or(hiddenFloat1), "Method or does not works with floats." + messageSeed);

        assertNull(hiddenBinary1.or(hiddenInt1), "Method or does not works with ints." + messageSeed);

        assertNull(hiddenBinary1.or(hiddenString1), "Method or does not works with string." + messageSeed);
    }
    ...
    void testSub() {
        ...
        assertNull(hiddenBinary1.sub(trueHiddenBool),
            "Method sub does not works with booleans." + messageSeed);
        assertNull(hiddenBinary1.sub(falseHiddenBool),
            "Method sub does not works with booleans." + messageSeed);

        assertNull(hiddenBinary1.sub(hiddenFloat1), "Method sub does not works with floats." + messageSeed);
        ...
        assertNull(hiddenBinary1.sub(hiddenString1), "Method sub does not works with strings." + messageSeed);
    }
}