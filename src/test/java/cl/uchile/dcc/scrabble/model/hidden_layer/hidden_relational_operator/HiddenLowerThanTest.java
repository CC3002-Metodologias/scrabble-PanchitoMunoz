...
class HiddenLowerThanTest extends BaseHiddenRelationalOperatorTest {
    ...
    protected void setUp() {
        ...
        greaterCase = new HiddenLowerThan(greaterNumber, lowerNumber);
        equalsCase = new HiddenLowerThan(hiddenBinary1, hiddenBinary1.toHiddenFloat());
        lowerCase = new HiddenLowerThan(lowerNumber, greaterNumber);
    }

    @RepeatedTest(20)
    void testEquals() {
        HiddenRelationalOperator other = new HiddenLowerThan(greaterNumber, lowerNumber);
    ...
    void testAsString() {
        ...
        for (HType hType1 : hTypeList2) {
            for (HType hType2 : hTypeList2) {
                ...
                assertEquals(expected, new HiddenLowerThan(hType1, hType2).asString(0),
    ...
    void testSize() {
        ...
        HiddenRelationalOperator operator = new HiddenLowerThan(hiddenFloat1, greaterCase);
    ...
    void testSetVariable() {
        HiddenRelationalOperator operator = new HiddenLowerThan(
    ...
    void testClone() throws CloneNotSupportedException {
        HiddenLowerThan operation = new HiddenLowerThan(hiddenFloat1, hiddenFloat2);
