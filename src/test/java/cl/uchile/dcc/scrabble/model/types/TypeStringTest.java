...
class TypeStringTest {
    ...
    void testEquals() {
        ...
        assertNotEquals(otherTypeString, typeString,
                "Two different instances are equals when it is not.");
        assertEquals(similarTypeString, typeString,
                "Two different instances are not equals when it is.");
    }
    ...
    void testToTypeString() {
        ...
        assertEquals(similarTypeString, typeString.toTypeString(),
                "Method toTypeString does not work.");
    }
}